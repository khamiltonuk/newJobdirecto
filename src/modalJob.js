...
export default class ModalJob extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <div onClick={this.props.close} className="backgroundBlock"></div>
        ...
        <main
          className={
            this.state.jobData.data.urgent === 'true' ? 'urgentModal' : 'modal'
          }
        >
          ...
          <div className="redFlagDiv">
            <p className="text">{this.context.modalJob.pleaseReport}</p>
          </div>
            ...
            {this.state.pleaseLogin == true && (
              <div>
                ...
                <Link className="callToLogin" to="/login">
                  ...
                  &nbsp;
                  <img className="star starJobForm" src="star.png" />
                </Link>
              </div>
            )}
