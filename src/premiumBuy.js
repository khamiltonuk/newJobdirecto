  ...
  render() {
    return (
      <div className="container">
        <p className="text">
          {' '}
          Las cuentas premium por ahora solo cuestan 5 dolares al mes. Este
          precio probablemente subira pronto.
          <br />
          <br />
          Solo las cuentas premium pueden cerrar sus anuncios. Pronto tambien
          podran editar sus anuncios y tendran un TOP post gratuito cada mes.
          <br />
          <br />
