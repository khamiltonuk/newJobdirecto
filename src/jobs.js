        ...
        {!this.state.user && (
          <Link to="/login">
            <div className="buttonsAuth">
              <img className="star starMini" src="star.png" />
              <p className="authText">{this.context.main.login}</p>
            </div>
          </Link>
        )}
        {this.state.user && (
          <p className="buttonsAuth" onClick={this.logOut}>
            {this.context.main.logout}
          </p>
        )}
                ...
                return (
                  ...
                  >
                    <div className="flexContainer">
                      <div className="postIcons">
                        ...
                        {data.facebookid !== null && (
                          <div data-tooltip={this.context.main.tooltip}>
                            {' '}
                    ...
                    <div className="postMoment">
                      <Moment className="postMomentChild" fromNow>
                        {data.created_at}
                      </Moment>
                    </div>
                  </div>
                    ...
                    <div className="flexContainer">
                      <div className="postIcons">
                        {data.facebookid === this.state.user.id && (
                          <button
                            onClick={event =>
                              this.showDeleteModal(event, data.id)
                            }
                            className="deletePostButton deletePaidButton"
                          >
                            <i className="fa fa-close" />
                  ...
                  >
                    <div className="flexContainer">
                      <div className="postIcons">
                        ...
                        {data.whoreported &&
                          data.whoreported.length &&
                          data.whoreported.length > 10 && (
                            <div data-tooltip={this.context.main.tooltip2}>
                              {' '}
